...
// import { Admin, Staff, Student } from '../.././sidebar/sidebar.component';
import {  Staff } from '../.././sidebar/sidebar.component';
...
export class NavbarComponent implements OnInit{
    ...
    constructor(location:Location, private renderer : Renderer2, private element : ElementRef, private router: Router,public dataservice: AuthService) {
    ...
    ngOnInit(){
        this.listTitles = Staff.filter(listTitle => listTitle);
        ...
        // if(this.url === "admin") {
        //     this.listTitles = admin;
        // } else if(this.url === "staff") {
        //     this.listTitles = staff;
        // } else {
        //     this.listTitles = student;
        // }
